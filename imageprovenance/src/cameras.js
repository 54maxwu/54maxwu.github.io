...
export const CAMERA_PROFILES = {
    ...
    huaweip70u: {
        group: 'phone',
        displayName: '華為 Pura 70 Ultra', icon: '📱',
...
export const CAMERA_GROUPS = [
    ...
    { id: 'dslr',    label: '無反 / 單反',  icon: '📷' },
    { id: 'compact', label: '緊湊 / 膠片感', icon: '🎞️' },
];
...
export const GPS_PRESETS = {
    ...
    beijing:  { label: '北京 · 故宮午門',       lat: 39.9163, lon: 116.3972 },
    shanghai: { label: '上海 · 外灘',           lat: 31.2397, lon: 121.4904 },
    gz:       { label: '廣州 · 小蠻腰',         lat: 23.1066, lon: 113.3245 },
    shenzhen: { label: '深圳 · 平安金融中心',   lat: 22.5370, lon: 114.0579 },
    chengdu:  { label: '成都 · 春熙路',         lat: 30.6530, lon: 104.0819 },
    hongkong: { label: '香港 · 維多利亞港',     lat: 22.2940, lon: 114.1694 },
    tokyo:    { label: '東京 · 澀谷站',         lat: 35.6580, lon: 139.7016 },
    nyc:      { label: '紐約 · 時代廣場',       lat: 40.7580, lon: -73.9855 },
};
