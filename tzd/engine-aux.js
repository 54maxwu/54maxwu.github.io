...
export const SX_NAMING={
  ...
  牛:{like:["艹","禾","豆","米","宀","车","田","水","氵"],avoid:["羊","马","心","忄","示","彳","刀"],
    likeWhy:"喜吃草料(艹禾豆)、有田有屋(田宀)",avoidWhy:"忌羊馬(沖)、忌心肉(牛不食葷)、忌示(被祭)",
    eg:["禾","秀","程","菁","茉","荷","莉","宏","宥","男","町","沛"]},
  虎:{like:["山","木","氵","水","王","君","令","月","肉","马","犭"],avoid:["申","袁","人","亻","小","口","日"],
  ...
  羊:{like:["艹","禾","豆","米","木","金","玉","田","几","门"],avoid:["心","忄","示","彳","王","大","氵"],
    likeWhy:"喜草料(艹禾豆米)、有柵欄(几门田)安身",avoidWhy:"忌心肉(羊不食葷)、忌大王(出頭被宰)",
  ...
  狗:{like:["亻","人","宀","心","忄","月","肉","糸","巾","金"],avoid:["氵","水","田","禾","艹","酉","鸡"],
...
export const SX_DETAIL={
  ...
  馬:{career:"行動力強、social 厲害，適合業務、傳媒、運動、外勤；閒不住。",
